...
printint(int fd, int xx, int base, int sgn)
{
 ...
 348:	0f b6 92 88 06 00 00 	movzbl 0x688(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 499:	75 28                	jne    4c3 <printf+0x12e>
          s = "(null)";
 49b:	be 81 06 00 00       	mov    $0x681,%esi
...
free(void *ap)
{
 ...
 512:	a1 34 09 00 00       	mov    0x934,%eax
 ...
 54e:	89 08                	mov    %ecx,(%eax)
  freep = p;
 550:	a3 34 09 00 00       	mov    %eax,0x934
}
 555:	5b                   	pop    %ebx
 556:	5e                   	pop    %esi
 557:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5ad:	e8 50 ff ff ff       	call   502 <free>
  return freep;
 5b2:	a1 34 09 00 00       	mov    0x934,%eax
...
malloc(uint nbytes)
{
 ...
 5da:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5dd:	8b 0d 34 09 00 00    	mov    0x934,%ecx
 ...
 5e9:	eb 4b                	jmp    636 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 5eb:	c7 05 34 09 00 00 38 	movl   $0x938,0x934
 5f2:	09 00 00 
 5f5:	c7 05 38 09 00 00 38 	movl   $0x938,0x938
 5fc:	09 00 00 
    base.s.size = 0;
 5ff:	c7 05 3c 09 00 00 00 	movl   $0x0,0x93c
 606:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 609:	b9 38 09 00 00       	mov    $0x938,%ecx
 ...
 61a:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 61d:	89 0d 34 09 00 00    	mov    %ecx,0x934
      return (void*)(p + 1);
 ...
 63b:	73 d3                	jae    610 <malloc+0x4a>
    if(p == freep)
 63d:	39 05 34 09 00 00    	cmp    %eax,0x934
