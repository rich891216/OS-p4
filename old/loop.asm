...
void loop(int sleepticks) {
   ...
   d:	e8 b2 02 00 00       	call   2c4 <sleep>
    int i = 0, j = 0;
    while (i < 800000000) {
  ...
  15:	b8 00 00 00 00       	mov    $0x0,%eax
    while (i < 800000000) {
  1a:	3d ff 07 af 2f       	cmp    $0x2faf07ff,%eax
  1f:	7f 05                	jg     26 <loop+0x26>
        j += i * j + 1;
        i++;
  21:	83 c0 01             	add    $0x1,%eax
  24:	eb f4                	jmp    1a <loop+0x1a>
    }
}
  26:	c9                   	leave  
  27:	c3                   	ret    
...
int main(int argc, char *argv[]) {
  28:	f3 0f 1e fb          	endbr32 
  2c:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  30:	83 e4 f0             	and    $0xfffffff0,%esp
  33:	ff 71 fc             	pushl  -0x4(%ecx)
  36:	55                   	push   %ebp
  37:	89 e5                	mov    %esp,%ebp
  39:	51                   	push   %ecx
  3a:	83 ec 04             	sub    $0x4,%esp
  3d:	8b 41 04             	mov    0x4(%ecx),%eax
    if (argc != 2) {
  40:	83 39 02             	cmpl   $0x2,(%ecx)
  43:	75 28                	jne    6d <main+0x45>
        // incorrect number of arguments
        exit();
    }
    int sleepticks = atoi(argv[1]);
  45:	83 ec 0c             	sub    $0xc,%esp
  48:	ff 70 04             	pushl  0x4(%eax)
  4b:	e8 7a 01 00 00       	call   1ca <atoi>
    if (sleepticks == 0) {
  50:	83 c4 10             	add    $0x10,%esp
  53:	85 c0                	test   %eax,%eax
  55:	74 1b                	je     72 <main+0x4a>
  ...
  5a:	50                   	push   %eax
  5b:	e8 a0 ff ff ff       	call   0 <loop>
    return 0;
}
  60:	b8 00 00 00 00       	mov    $0x0,%eax
  65:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  68:	c9                   	leave  
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 348:	0f b6 92 5c 06 00 00 	movzbl 0x65c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 499:	75 28                	jne    4c3 <printf+0x12e>
          s = "(null)";
 49b:	be 54 06 00 00       	mov    $0x654,%esi
...
free(void *ap)
{
 ...
 512:	a1 28 09 00 00       	mov    0x928,%eax
 ...
 54e:	89 08                	mov    %ecx,(%eax)
  freep = p;
 550:	a3 28 09 00 00       	mov    %eax,0x928
}
 555:	5b                   	pop    %ebx
 556:	5e                   	pop    %esi
 557:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5ad:	e8 50 ff ff ff       	call   502 <free>
  return freep;
 5b2:	a1 28 09 00 00       	mov    0x928,%eax
...
malloc(uint nbytes)
{
 ...
 5da:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5dd:	8b 0d 28 09 00 00    	mov    0x928,%ecx
 ...
 5e9:	eb 4b                	jmp    636 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 5eb:	c7 05 28 09 00 00 2c 	movl   $0x92c,0x928
 5f2:	09 00 00 
 5f5:	c7 05 2c 09 00 00 2c 	movl   $0x92c,0x92c
 5fc:	09 00 00 
    base.s.size = 0;
 5ff:	c7 05 30 09 00 00 00 	movl   $0x0,0x930
 606:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 609:	b9 2c 09 00 00       	mov    $0x92c,%ecx
 ...
 61a:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 61d:	89 0d 28 09 00 00    	mov    %ecx,0x928
      return (void*)(p + 1);
 ...
 63b:	73 d3                	jae    610 <malloc+0x4a>
    if(p == freep)
 63d:	39 05 28 09 00 00    	cmp    %eax,0x928
